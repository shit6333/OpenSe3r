...
class Infinigen_Arrow(BaseManyViewDataset):
    """
    Infinigen Arrow loader for per-subscene Arrow export.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.depth_invalid_threshold_m = depth_invalid_threshold_m
        self._scene_cache = {}
    ...
    def _get_views(self, idx, resolution, num_frames, rng, attempts=0):
        ...
        while len(imgs_idxs) > 0:
            ...
            # exported as uint16 millimeters -> back to meters
            depthmap = np.nan_to_num(depthmap.astype(np.float32), 0.0) / 1000.0
            depthmap[depthmap > self.depth_invalid_threshold_m] = 0.0
...
if __name__ == "__main__":
    ...
    dataset = Infinigen_Arrow(
        split="train",
        ROOT="./data/infinigen_arrow",
        resolution=224,
        num_seq=1,
        num_frames=5,
    )
