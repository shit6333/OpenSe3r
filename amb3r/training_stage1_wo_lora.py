...
TRAINABLE_KEYWORDS = [
    'clip_patch_fusion', 'frame_blocks', 'global_blocks',
    'semantic_head', 'instance_head',
    'sem_expander', 'instance_token',
]
    ...
    for i, batch in enumerate(metric_logger.log_every(data_loader, args.print_freq, header)):
        ...
        if i < 5 and misc.is_main_process():
            ...
            if 'instance_feat' in pred:
                ...
                # print('Exported instance HDBScan visualization for batch', i)
